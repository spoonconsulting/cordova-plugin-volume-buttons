...
@interface CDVVolumeButtonsController ()
...
@implementation CDVVolumeButtonsController
...
+ (instancetype)volumeButtonHandlerWithUpBlock:(CDVVolumeButtonBlock)upBlock downBlock:(CDVVolumeButtonBlock)downBlock {
    CDVVolumeButtonsController *instance = [[CDVVolumeButtonsController alloc] init];
    if (instance) {
